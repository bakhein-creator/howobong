...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="bg-white rounded-3xl shadow-2xl p-8 max-w-2xl w-full text-center">
        ...
        <div class="flex flex-col items-center mb-8">
            <!-- 시각적 저수율 표시 (Water Level Visualization) -->
            ...
            <div class="grid md:grid-cols-2 gap-4 text-left">
                ...
                <div class="bg-blue-50 p-4 rounded-xl shadow-md">
                    ...
                    <ul class="list-disc list-inside text-gray-700">
                        ...
                        <li>음식물 찌꺼기는 미리 제거하고 닦으면 물 사용량이 줄어듭니다.</li>
                    </ul>
                </div>
                <div class="bg-blue-50 p-4 rounded-xl shadow-md">
        ...
        <p class="text-sm text-gray-500 mt-4">
            <span class="font-bold">참고:</span> 이 저수율 데이터는 데모용으로, 실제 실시간 데이터와는 다를 수 있습니다.
        </p>

    </div>

    <script>
        // 현재 오봉댐 저수율 데이터를 설정합니다 (데모용)
        const currentWaterLevel = 60.0; // Google Search 결과에 기반하여 60.0%로 설정
